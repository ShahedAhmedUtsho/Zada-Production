import { AlignJustify, Facebook, ShoppingCart, X } from "lucide-react";
...
const Header = () => {
  ...
  return (
    <>
        ...
        <div className="text-white flex justify-center items-center gap-3">
          <div className="flex justify-center gap-5 items-center">
            <div className="relative  ">
              ...
              {/* <span className=" text-[8px] absolute bg-white px-1 rounded-full text-black -right-3 -bottom-1">
                0
              </span> */}
            </div>
          {!user ? (  <Link
          ...
          <AlignJustify
            ...
            size={30}
            className="  font-thin border transition-all  duration-200   border-current hover:text-amber-600  text-gray-400 p-1"
          />
        </div>
      </div>
      ...
      <>
        <div
          className={`flex flex-col transition-all  duration-300   py-10 pl-5 lg:pl-10  ${isOpen ? "right-0" : "right-[-1500px]"} bg-[#1a1a1a]   z-[999]  fixed top-0  w-full lg:w-4/12 min-h-screen`}
        >
          <X
            onClick={() => {
              setIsOpen(!isOpen);
            ...
            size={22}
            className=" z-[1000] absolute top-7 right-5 transition-all  duration-300 text-white hover:opacity-100 opacity-65 font-thin  border-gray-500 "
          />
          ...
          <div className="lg:mb-10 md:mb-8 mb-5">
            ...
            <p className="dm text-base md:text-lg leading-relaxed  tracking-normal mb-4">
              {" "}
              welcome to Zada production . Check out our services
            </p>
          </div>
          ...
          <ul className=" text-gray-300 opacity-80 ">
            <p className="dm text-sm md:text-base    leading-relaxed tracking-normal mb-4">
              Ekuria, keranigonj, Dhaka,{" "}
            </p>
            <p className="dm text-sm md:text-base leading-relaxed tracking-normal mb-4">
              +880 1999679464
            </p>
            <p className="dm text-sm md:text-base leading-relaxed tracking-normal mb-4">
              zadaproductionofficial@gmail.com
            </p>
          </ul>
          ...
          <div className="md:grid hidden grid-cols-3 max-w-96 min-h-52 pr-10 mt-10  gap-2">
            <div className="bg-slate-400 rounded-sm ">
              <img
                src="https://askproject.net/rayan/wp-content/uploads/sites/106/2022/10/portrait-of-an-asia-beautiful-girl-A3EB9AP.jpg"
                alt="grid photo"
              />
            </div>
            <div className="bg-slate-400 rounded-sm ">
